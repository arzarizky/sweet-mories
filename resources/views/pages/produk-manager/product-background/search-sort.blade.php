<form action="">
    <div class="row">
        <div class="col-sm-7 col-lg-7 col-md-7">
            <div class="card p-3">
                <div class="input-group input-group-merge">
                    ...
                    <input type="search" class="form-control" placeholder="Cari nama background product" aria-label="Search..."
        ...
        <div class="col-sm-3 col-lg-3 col-md-3">
            <div class="card p-3">
                <a href="{{route("product-manager-product-background-add")}}" class="btn btn-info">Add Product Background</a>
            </div>
        </div>
    </div>
