...
<li class="nav-item px-2 position-relative"><a
        class="nav-link pt-0 {{ request()->segment(1) == 'portfolio' ? 'active' : '' }}" aria-current="page"
        href="{{ route('portfolio-landing') }}">Portfolio</a>
</li>
<li class="nav-item px-2 position-relative"><a
...
<li class="nav-item px-2 position-relative"><a
        ...
        href="{{ route('exhibitions-landing') }}">Exhibitions</a>
</li>
<li class="nav-item px-2 position-relative"><a
