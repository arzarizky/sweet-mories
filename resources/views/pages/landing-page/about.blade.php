                                ...
                                <div class="card border-0 mb-3"><img class="card-img-top"
                                    ...
                                    <div class="row g-0 card-body px-0 pt-2">
                                        ...
                                        <div class="col-12 col-xl-4 justify-content-center fs-2 d-flex gap-1"><a
                                                href="{{ asset('template-landing') }}/public/#!"><span
                                                    class="team-social-icon fab fa-linkedin ml-3"></span></a><a
                                                href="{{ asset('template-landing') }}/public/#!"><span
                                                    class="team-social-icon fab fa-facebook ml-3"></span></a><a
                                                href="{{ asset('template-landing') }}/public/#!"><span
                                                    class="team-social-icon fab fa-instagram ml-3"></span></a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 d-flex justify-content-center">
