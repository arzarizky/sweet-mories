...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Exhibitions | Sweet Moris</title>
                            ...
                            <div class="swiper-container swiper-theme"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="row align-items-xl-center">
                                            <div class="col-lg-5"><img class="img-fluid w-100"
                                                    src="{{ asset('template-landing') }}/public/assets/img/exhibitions/img01.png"
                                                    alt="" />
                                                <div
                                                    ...
                                                    <span class="rounded-circle bg-white p-2 d-block"></span><span
                                                        class="text-white fw-bold">2017</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-xl-5 mt-4 mt-lg-0">
                                                ...
                                                <p class="fs-0">s a genre of Japanese art that became popular in the
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row align-items-xl-center">
                                            <div class="col-lg-5"><img class="img-fluid w-100"
                                                    src="{{ asset('template-landing') }}/public/assets/img/exhibitions/img02.png"
                                                    alt="" />
                                                <div
                                                    class="position-absolute top-5 start-5 mt-n1 d-flex flex-column align-items-center">
                                                    <span class="rounded-circle bg-white p-2 d-block"></span><span
                                                        class="text-white fw-bold">2015</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-xl-5 mt-4 mt-lg-0">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row align-items-xl-center">
                                            <div class="col-lg-5"><img class="img-fluid w-100"
                                                    src="{{ asset('template-landing') }}/public/assets/img/exhibitions/img03.png"
                                                    alt="" />
                                                <div
                                                    class="position-absolute top-5 start-5 mt-n1 d-flex flex-column align-items-center">
                                                    <span class="rounded-circle bg-white p-2 d-block"></span><span
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row align-items-xl-center">
                                            <div class="col-lg-5"><img class="img-fluid w-100"
                                                    src="{{ asset('template-landing') }}/public/assets/img/exhibitions/img04.png"
                                                    alt="" />
                                                <div
                                                    class="position-absolute top-5 start-5 mt-n1 d-flex flex-column align-items-center">
                                                    <span class="rounded-circle bg-white p-2 d-block"></span><span
