...
<li class="nav-item"><a
        ...
        aria-current="page" href="{{ route('portfolio-landing') }}">About us</a>
</li>
<li class="nav-item"><a
...
<li class="nav-item"><a
        ...
        aria-current="page" href="{{ route('exhibitions-landing') }}">Pricelist</a>
</li>
<li class="nav-item"><a
        class="nav-link d-inline-block nav-text-outlined lh-1 text-white fs-5 {{ request()->segment(1) == 'about' ? 'active' : '' }}"
        aria-current="page" href="{{ route('about-landing') }}">Location</a>
</li>
<li class="nav-item"><a
