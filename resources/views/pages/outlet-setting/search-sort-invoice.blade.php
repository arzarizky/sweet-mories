<form action="">
    <div class="row">
        <div class="col-sm-7 col-lg-7 col-md-7 mb-4">
            <div class="card p-3">
                <div class="input-group input-group-merge">
                    ...
                    <input type="search" class="form-control" placeholder="Cari nama atau kode promo"
        ...
        <div class="col-sm-3 col-lg-3 col-md-3">
            <div class="card p-3">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCloseOutlet">
                    Add Jadwal Tutup
                </button>
            </div>
        </div>
